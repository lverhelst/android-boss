...
public class SaveGame extends DefaultHandler {
    ...
    public static Character leftside, rightside;
    ...
    public static void saveGame(Character A, Character B, int[] stats){
            ...
            String s = "<?xml version=\"1.0\"?>\n" +
                    ...
                    "        <Max_Level>" + A.max_level + "</Max_Level>\n" +
                    "        <Max_WTNL>" + A.max_wtnl + "</Max_WTNL>\n" +
                    ...
                    "        <Max_Level>" + B.max_level + "</Max_Level>\n" +
                    "        <Max_WTNL>" + B.max_wtnl + "</Max_WTNL>\n" +
                    "        <WinStreak>" + B.getWin_streak() + "</WinStreak>\n" +
                    "        <LoseStreak>" + B.getLose_streak() + "</LoseStreak>\n" +
                    "        <Head>" + B.spriteindices[0]+ "</Head>\n" +
                    "        <Torso>"+ B.spriteindices[1]+ "</Torso>\n" +
                    "        <Legs>"+ B.spriteindices[2]+ "</Legs>\n" +
                    "        <Shoulder>"+ B.spriteindices[3]+  "</Shoulder>\n" +
                    "        <Elbow>" + B.spriteindices[4]+ "</Elbow>\n" +
                    "        <Weapon>\n" +
        ...
        switch(state){
            ...
            case CHAR1:
                ...
                if(currentNode.equalsIgnoreCase("max_level")){
                    leftside.max_level = Integer.parseInt(str);
                }
                if(currentNode.equalsIgnoreCase("max_wtnl")){
                    leftside.max_wtnl = Integer.parseInt(str);
                }
                if(currentNode.equalsIgnoreCase("winstreak")){
                    leftside.win_streak = (Integer.parseInt(str));
                }
                if(currentNode.equalsIgnoreCase("losestreak")){
                    leftside.lose_streak = (Integer.parseInt(str));
                }
            ...
            case CHAR2:
                ...
                if(currentNode.equalsIgnoreCase("max_level")){
                    rightside.max_level = Integer.parseInt(str);
                }
                if(currentNode.equalsIgnoreCase("max_wtnl")){
                    rightside.max_wtnl = Integer.parseInt(str);
                }
                if(currentNode.equalsIgnoreCase("winstreak")){
                    rightside.win_streak = (Integer.parseInt(str));
                }
                if(currentNode.equalsIgnoreCase("losestreak")){
                    rightside.lose_streak = (Integer.parseInt(str));
                }
                if(currentNode.equalsIgnoreCase("head")){
